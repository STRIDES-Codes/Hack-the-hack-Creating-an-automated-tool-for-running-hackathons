...
def uploadDocs(project_dictionary):
    ...
    for project in allProjects:
            uploadDoc(project_dictionary['drive_auth_key'], project['team_name'])
